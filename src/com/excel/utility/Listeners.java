...
public class Listeners implements  ITestListener, ISuiteListener, IInvokedMethodListener {
	...
	public void takeScreenShot(String methodName, WebDriver driver) {
		...
		try {
			FileUtils.copyFile(scrFile, new File("/Users/bvennapureddy/Desktop/TRAINING" + methodName + ".png"));
			System.out.println("***Placed screen shot in " + "/Users/bvennapureddy/Desktop/TRAINING" + " ***");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
